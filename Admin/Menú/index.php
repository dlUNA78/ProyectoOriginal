...
<html data-bs-theme="light" lang="en">
  ...
  <body id="page-top">
    <div id="wrapper">
      <nav
        class="navbar d-flex align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark"
          ...
          <ul class="navbar-nav text-light" id="accordionSidebar">
            <li class="nav-item">
              <a class="nav-link active" href="../Menú/index.html"
                ...
                ><span style="color: var(--bs-black); margin-left: 10px"
                  >Principal</span
                ></a
              >
            </li>
